    ...
    <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div className="space-y-4">
        ...
        <p className="text-lg  text-gray-600 font-nonHeadingFont">
          Hello, I&apos;m Naga Sai. I&apos;m a Software Engineer adept in both frontend and backend systems. Beyond the lines of code, my curiosity extends to the realms of physics and governance, adding a unique perspective to my tech-driven world.
        </p>
