    ...
    <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="space-y-4">
          ...
          <Button className="mt-4 font-secondaryFont bg-green-500 text-white  py-2 px-4 rounded hover:bg-green-600 transition-colors duration-300 ease-in-out shadow-md hover:shadow-lg border border-transparent hover:border-gray-200 transform hover:scale-105">
